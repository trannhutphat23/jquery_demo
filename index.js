function render(info){
    const userInfoHtml = info.map(item => {
        return `
            <div class="user-info-card" id=`+item.id+`>
                <div class="header-info">
                    <img class="user-avatar" src="`+ item.image +`" alt="" />
                ...
                <button type="button" class="btn_detail" id="btn-`+item.id+`">PROFILE</button>
            </div> `
    })
    $(".info").html(userInfoHtml.join(''));
}

$(document).ready(function(){
    // Set default for search input
    $(".search-container").addClass("hidden");
    // Click tab thông tin chung
    $("#generalInfo").click(function(){
        $(".InfoGroup").show();
        $(".info").hide();
        $(".search-container").addClass("hidden");
    })
    // Click tab thành viến
    $("#infoTeam").click(function(){
        $(".InfoGroup").hide();
        $(".info").show();
    ...
    // Xử lý click event search button
    $(".search-button").click(function(){
        let valueInput = $(".search-input").val();
        $(".search-input").val("");
        if (valueInput == ""){
            $.ajax({
                type: 'GET',
    ...
    // Effect hover
    $(".info").on("mouseenter", ".user-info-card", function(){
        var getID = $(this).children('button').attr('id');
        $("#"+getID).show();
        $(this).css("backgroundColor", "rgb(209, 207, 207)");
        $(".btn_detail").on("click", function(){
            var getID = $(this).parent().closest('.user-info-card').attr('id');
            location.href = "./profile.html?id="+getID+"";
        })
    })
    $(".info").on("mouseleave", ".user-info-card", function(){
        var getID = $(this).children('button').attr('id');
        $("#"+getID).hide();
